...
/* other tools */
    ...
    TOOL("N{f,N{can},N{grease}}", NULL, 1, 0, 0, 1, 15, 15, 20, IRON, HI_METAL),
...
/* meat */
    ...
    FOOD("N{f,N{N{chunk},A{huge}},N{meat}}", 0, 20, 400, 0, FLESH,
         2000, CLR_BROWN),
...
/* fruits & veggies */
    ...
    FOOD("N{f,N{sprig},N{wolfsbane}}", 7, 1, 1, 0, VEGGY, 40, CLR_GREEN),
    FOOD("N{f,N{clove},N{garlic}}", 7, 1, 1, 0, VEGGY, 40, CLR_WHITE),
    FOOD("N{slime mold}", 75, 1, 5, 0, VEGGY, 250, HI_ORGANIC),

/* people food */
    FOOD("N{f,N{lump},N{royal jelly}}", 0, 1, 2, 0, VEGGY, 200, CLR_YELLOW),
...
#define ROCK(name,desc,kn,prob,wt,gval,sdam,ldam,mgc,nutr,mohs,glass,color) OBJECT( \
    ...
    GEM("N{N{f,N{piece},N{N{glass},A{white}}},A{worthless}}", "A{white}",
        77, 1, 0, 6, 5, GLASS, CLR_WHITE),
    GEM("N{N{f,N{piece},N{N{glass},A{blue}}},A{worthless}}", "A{blue}",
        77, 1, 0, 6, 5, GLASS, CLR_BLUE),
    GEM("N{N{f,N{piece},N{N{glass},A{red}}},A{worthless}}", "A{red}",
        77, 1, 0, 6, 5, GLASS, CLR_RED),
    GEM("N{N{f,N{piece},N{N{glass},A{yellowish-brown}}},A{worthless}}",
        "A{yellowish-brown}", 77, 1, 0, 6, 5, GLASS, CLR_BROWN),
    GEM("N{N{f,N{piece},N{N{glass},A{orange}}},A{worthless}}", "A{orange}",
        76, 1, 0, 6, 5, GLASS, CLR_ORANGE),
    GEM("N{N{f,N{piece},N{N{glass},A{yellow}}},A{worthless}}", "A{yellow}",
        77, 1, 0, 6, 5, GLASS, CLR_YELLOW),
    GEM("N{N{f,N{piece},N{N{glass},A{black}}},A{worthless}}", "A{black}",
        76, 1, 0, 6, 5, GLASS, CLR_BLACK),
    GEM("N{N{f,N{piece},N{N{glass},A{green}}},A{worthless}}", "A{green}",
        77, 1, 0, 6, 5, GLASS, CLR_GREEN),
    GEM("N{N{f,N{piece},N{N{glass},A{violet}}},A{worthless}}", "A{violet}",
