 ...
 *
 * * Use approximately the same color for all `growth stages' of a monster
 *   (e.g. little dog/big dog, baby naga/full-grown naga); older stages get
 *   brighter colors or underscores.
 *
 ...
 */
    ...
    MON("N{N{blob},A{quivering}}", S_BLOB,
    ...
    MON("N{N{cube},A{gelatinous}}", S_BLOB,
 ...
 * cockatrice
 */
    MON("N{chickatrice}", S_COCKATRICE,
 ...
 */
    ...
    MON("N{warg}", S_DOG,
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        CLR_BRIGHT_GREEN),
    MON("N{N{cub},A{N{N{wolf},A{N{winter}}}}}", S_DOG,
    ...
    MON("N{N{pup},A{N{N{hound},A{N{hell}}}}}", S_DOG,
 ...
 */
    ...
    MON("N{N{sphere},A{freezing}}", S_EYE,
    ...
    MON("N{N{sphere},A{flaming}}", S_EYE,
    ...
    MON("N{N{sphere},A{shocking}}", S_EYE,
        LVL(6, 13, 4, 0, 0), (G_NOCORPSE | G_GENO | 2),
 ...
 */
    ...
    MON("N{N{gargoyle},A{winged}}", S_GREMLIN,
 ...
 */
    ...
    MON("N{N{lord},A{N{dwarf}}}", S_HUMANOID,
    ...
    MON("N{N{king},A{N{dwarf}}}", S_HUMANOID,
    ...
    MON("N{N{mind flayer},A{master}}", S_HUMANOID,
 ...
 */
    ...
    MON("N{N{jelly},A{spotted}}", S_JELLY,
 ...
 */
    MON("N{kobold}", S_KOBOLD,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_BROWN),
    MON("N{N{kobold},A{large}}", S_KOBOLD,
        ...
        M1_HUMANOID | M1_POIS | M1_OMNIVORE, M2_HOSTILE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_RED),
    MON("N{N{lord},A{N{kobold}}}", S_KOBOLD,
        ...
        HI_LORD),
    MON("N{N{shaman},A{N{kobold}}}", S_KOBOLD,
 ...
 * nymphs
 */
    MON("N{N{nymph},A{N{wood}}}", S_NYMPH,
    ...
    MON("N{N{nymph},A{N{water}}}", S_NYMPH,
        LVL(3, 12, 9, 20, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, 0, MS_SEDUCE, MZ_HUMAN), 0, 0,
    ...
    MON("N{N{nymph},A{N{mountain}}}", S_NYMPH,
        LVL(3, 12, 9, 20, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, 0, MS_SEDUCE, MZ_HUMAN), 0, 0,
 ...
 * piercers
 */
    MON("N{N{piercer},A{N{rock}}}", S_PIERCER,
    ...
    MON("N{N{piercer},A{N{iron}}}", S_PIERCER,
    ...
    MON("N{N{piercer},A{N{glass}}}", S_PIERCER,
 ...
 */
    ...
    MON("N{baluchitherium}", S_QUADRUPED,
 ...
 * rodents
 */
    MON("N{N{rat},A{N{sewer}}}", S_RODENT,
    ...
    MON("N{wererat}", S_RODENT,
        ...
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE,
        CLR_BROWN | HI_ULINE),
    MON("N{N{mole},A{N{rock}}}", S_RODENT,
 ...
 */
    MON("N{N{spider},A{N{cave}}}", S_SPIDER,
    ...
    MON("N{N{spider},A{giant}}", S_SPIDER,
 ...
 * unicorns and horses
 */
    MON("N{N{unicorn},A{white}}", S_UNICORN,
    ...
    MON("N{N{unicorn},A{gray}}", S_UNICORN,
    ...
    MON("N{N{unicorn},A{black}}", S_UNICORN,
 ...
 * vortices
 */
    MON("N{N{cloud},A{N{fog}}}", S_VORTEX,
        ...
        M2_HOSTILE | M2_NEUTER, 0, CLR_GRAY),
    MON("N{N{vortex},A{N{dust}}}", S_VORTEX,
        ...
        M1_MINDLESS,
        M2_HOSTILE | M2_NEUTER, 0, CLR_BROWN),
    MON("N{N{vortex},A{N{ice}}}", S_VORTEX,
    ...
    MON("N{N{vortex},A{N{energy}}}", S_VORTEX,
    ...
    MON("N{N{vortex},A{N{steam}}}", S_VORTEX,
        ...
        M1_MINDLESS | M1_UNSOLID,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, CLR_BLUE),
    MON("N{N{vortex},A{N{fire}}}", S_VORTEX,
 ...
 * worms
 */
    MON("N{N{N{worm},A{long}},A{baby}}", S_WORM,
        ...
        M2_HOSTILE, 0, CLR_BROWN),
    MON("N{N{N{worm},A{purple}},A{baby}}", S_WORM,
        LVL(8, 3, 5, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 250, 0, MS_SILENT, MZ_LARGE), 0, 0,
 ...
 * lights
 */
    MON("N{N{light},A{yellow}}", S_LIGHT,
 ...
 * Centaurs
 */
    MON("N{N{centaur},A{N{plains}}}", S_CENTAUR,
        ...
        M3_INFRAVISIBLE, CLR_BROWN),
    MON("N{N{centaur},A{N{forest}}}", S_CENTAUR,
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_STRONG | M2_GREEDY | M2_COLLECT,
        M3_INFRAVISIBLE, CLR_GREEN),
    MON("N{N{centaur},A{N{mountain}}}", S_CENTAUR,
 ...
 */
    ...
    MON("N{N{N{dragon},A{gray}},A{baby}}", S_DRAGON,
    ...
    MON("N{N{N{dragon},A{silver}},A{baby}}", S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, 0, MS_ROAR, MZ_HUGE), 0, 0,
    ...
    MON("N{N{N{dragon},A{red}},A{baby}}", S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        CLR_RED),
    MON("N{N{N{dragon},A{white}},A{baby}}", S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("N{N{N{dragon},A{orange}},A{baby}}", S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("N{N{N{dragon},A{black}},A{baby}}", S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("N{N{N{dragon},A{blue}},A{baby}}", S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("N{N{N{dragon},A{green}},A{baby}}", S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("N{N{N{dragon},A{yellow}},A{baby}}", S_DRAGON,
        LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("N{N{dragon},A{gray}}", S_DRAGON,
        ...
        CLR_GRAY | HI_ULINE),
    MON("N{N{dragon},A{silver}}", S_DRAGON,
        LVL(15, 9, -1, 20, 4), (G_GENO | 1),
    ...
    MON("N{N{dragon},A{red}}", S_DRAGON,
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        M3_INFRAVISIBLE, CLR_RED | HI_ULINE),
    MON("N{N{dragon},A{white}}", S_DRAGON,
        ...
        M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, CLR_WHITE | HI_ULINE),
    MON("N{N{dragon},A{orange}}", S_DRAGON,
        LVL(15, 9, -1, 20, 5), (G_GENO | 1),
    ...
    MON("N{N{dragon},A{black}}", S_DRAGON,
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC, 0,
        CLR_BLACK | HI_ULINE),
    MON("N{N{dragon},A{blue}}", S_DRAGON,
    ...
    MON("N{N{dragon},A{green}}", S_DRAGON,
        LVL(15, 9, -1, 20, 6), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC, 0,
        CLR_GREEN | HI_ULINE),
    MON("N{N{dragon},A{yellow}}", S_DRAGON,
        LVL(15, 9, -1, 20, 7), (G_GENO | 1),
 ...
 */
    MON("N{stalker}", S_ELEMENTAL,
        ...
        CLR_WHITE),
    MON("N{N{elemental},A{N{air}}}", S_ELEMENTAL,
    ...
    MON("N{N{elemental},A{N{fire}}}", S_ELEMENTAL,
    ...
    MON("N{N{elemental},A{N{earth}}}", S_ELEMENTAL,
    ...
    MON("N{N{elemental},A{N{water}}}", S_ELEMENTAL,
        LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
 ...
 */
    ...
    MON("N{N{mold},A{brown}}", S_FUNGUS,
        ...
        M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, CLR_BROWN),
    MON("N{N{mold},A{yellow}}", S_FUNGUS,
    ...
    MON("N{shrieker}", S_FUNGUS,
        ...
        M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, CLR_BLUE),
    MON("N{N{fungus},A{violet}}", S_FUNGUS,
 ...
 */
    MON("N{gnome}", S_GNOME,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_BROWN),
    MON("N{N{lord},A{N{gnome}}}", S_GNOME,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_BLUE),
    MON("N{N{wizard},A{gnomish}}", S_GNOME,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, HI_ZAP),
    MON("N{N{king},A{N{gnome}}}", S_GNOME,
 ...
 */
    MON("N{giant}", S_GIANT,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_RED),
    MON("N{N{giant},A{N{stone}}}", S_GIANT,
        ...
        M2_GIANT | M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_GRAY),
    MON("N{N{giant},A{N{hill}}}", S_GIANT,
    ...
    MON("N{N{giant},A{N{fire}}}", S_GIANT,
        ...
        M2_GIANT | M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_YELLOW),
    MON("N{N{giant},A{N{frost}}}", S_GIANT,
        ...
        M2_GIANT | M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_WHITE),
    MON("N{N{giant},A{N{storm}}}", S_GIANT,
 ...
 * Mummies
 */
    MON("N{N{mummy},A{N{kobold}}}", S_MUMMY,
    ...
    MON("N{N{mummy},A{N{gnome}}}", S_MUMMY,
    ...
    MON("N{N{mummy},A{N{orc}}}", S_MUMMY,
        ...
        CLR_GRAY),
    MON("N{N{mummy},A{N{dwarf}}}", S_MUMMY,
        LVL(5, 10, 5, 20, -4), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 150, 0, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON,
        0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_UNDEAD | M2_HOSTILE | M2_DWARF | M2_GREEDY | M2_JEWELS,
        M3_INFRAVISION,
        CLR_RED),
    MON("N{N{mummy},A{N{elf}}}", S_MUMMY,
    ...
    MON("N{N{mummy},A{N{human}}}", S_MUMMY,
        LVL(6, 12, 4, 30, -5), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("N{N{mummy},A{N{ettin}}}", S_MUMMY,
    ...
    MON("N{N{mummy},A{N{giant}}}", S_MUMMY,
 ...
 * Nagas
 */
    MON("N{N{N{hatchling},A{N{naga}}},A{red}}", S_NAGA,
        ...
        M2_STRONG,
        M3_INFRAVISIBLE, CLR_RED),
    MON("N{N{N{hatchling},A{N{naga}}},A{black}}", S_NAGA,
        LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 100, 0, MS_MUMBLE, MZ_LARGE),
    ...
    MON("N{N{N{hatchling},A{N{naga}}},A{golden}}", S_NAGA,
        LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
        M2_STRONG, 0, HI_GOLD),
    MON("N{N{N{hatchling},A{N{naga}}},A{guardian}}", S_NAGA,
        LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 100, 0, MS_MUMBLE, MZ_LARGE), MR_POISON, MR_POISON,
    ...
    MON("N{N{naga},A{guardian}}", S_NAGA,
 ...
 */
    MON("N{N{ooze},A{gray}}", S_PUDDING,
        ...
        M2_HOSTILE | M2_NEUTER, 0, CLR_GRAY),
    MON("N{N{pudding},A{brown}}", S_PUDDING,
        ...
        M1_MINDLESS | M1_OMNIVORE | M1_ACID,
        M2_HOSTILE | M2_NEUTER, 0, CLR_BROWN),
    MON("N{N{pudding},A{black}}", S_PUDDING,
        ...
        M1_MINDLESS | M1_OMNIVORE | M1_ACID,
        M2_HOSTILE | M2_NEUTER, 0, CLR_BLACK),
    MON("N{N{slime},A{green}}", S_PUDDING,
 ...
 * Quantum mechanics
 */
    MON("N{quantum mechanic}", S_QUANTMECH,
 ...
 */
    MON("N{N{monster},A{N{rust}}}", S_RUSTMONST,
        ...
        M3_INFRAVISIBLE, CLR_BROWN),
    MON("N{disenchanter}", S_RUSTMONST,
 ...
 */
    ...
    MON("N{snake}", S_SNAKE,
        ...
        M2_HOSTILE, 0, CLR_BROWN),
    MON("N{N{moccasin},A{N{water}}}", S_SNAKE,
 ...
 */
    ...
    MON("N{N{troll},A{N{ice}}}", S_TROLL,
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        CLR_WHITE),
    MON("N{N{troll},A{N{rock}}}", S_TROLL,
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_CYAN),
    MON("N{N{troll},A{N{water}}}", S_TROLL,
 ...
 */
    MON("N{vampire}", S_VAMPIRE,
        ...
        M3_INFRAVISIBLE,
        CLR_RED),
    MON("N{N{lord},A{N{vampire}}}", S_VAMPIRE,
        ...
        M2_MALE,
        M3_INFRAVISIBLE, CLR_BLUE),
    MON("P{Vlad the Impaler}", S_VAMPIRE,
 ...
 * Wraiths
 */
    MON("N{N{wight},A{N{barrow}}}", S_WRAITH,
 ...
 */
    ...
    MON("N{yeti}", S_YETI,
        ...
        M3_INFRAVISIBLE, CLR_WHITE),
    MON("N{N{ape},A{carnivorous}}", S_YETI,
 ...
 * Zombies
 */
    MON("N{N{zombie},A{N{kobold}}}", S_ZOMBIE,
    ...
    MON("N{N{zombie},A{N{gnome}}}", S_ZOMBIE,
        ...
        CLR_BROWN | HI_ULINE),
    MON("N{N{zombie},A{N{orc}}}", S_ZOMBIE,
    ...
    MON("N{N{zombie},A{N{dwarf}}}", S_ZOMBIE,
        LVL(2, 6, 9, 0, -3), (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 150, 0, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON,
    ...
    MON("N{N{zombie},A{N{elf}}}", S_ZOMBIE,
    ...
    MON("N{N{zombie},A{N{human}}}", S_ZOMBIE,
    ...
    MON("N{N{zombie},A{N{ettin}}}", S_ZOMBIE,
        ...
        CLR_BLUE),
    MON("N{N{zombie},A{N{giant}}}", S_ZOMBIE,
 ...
 * golems
 */
    MON("N{N{golem},A{N{straw}}}", S_GOLEM,
    ...
    MON("N{N{golem},A{N{paper}}}", S_GOLEM,
        LVL(3, 12, 10, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 0, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON, 0,
    ...
    MON("N{N{golem},A{N{rope}}}", S_GOLEM,
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_HOSTILE | M2_NEUTER, 0, CLR_BLUE),
    MON("N{N{golem},A{N{gold}}}", S_GOLEM,
    ...
    MON("N{N{golem},A{N{leather}}}", S_GOLEM,
    ...
    MON("N{N{golem},A{N{wood}}}", S_GOLEM,
    ...
    MON("N{N{golem},A{N{flesh}}}", S_GOLEM,
        LVL(9, 8, 9, 30, 0), (1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
        M2_HOSTILE | M2_STRONG, 0, CLR_RED),
    MON("N{N{golem},A{N{clay}}}", S_GOLEM,
    ...
    MON("N{N{golem},A{N{stone}}}", S_GOLEM,
        LVL(14, 6, 5, 50, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1900, 0, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON | MR_STONE,
        0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, CLR_GRAY),
    MON("N{N{golem},A{N{glass}}}", S_GOLEM,
    ...
    MON("N{N{golem},A{N{iron}}}", S_GOLEM,
 ...
 */
    ...
    MON("N{Oracle}", S_HUMAN,
        ...
        CLR_BRIGHT_BLUE | HI_ULINE),
    MON("N{N{priest},A{aligned}}", S_HUMAN,
        ...
        M3_INFRAVISIBLE,
        CLR_YELLOW),
    MON("N{N{priest},A{high^rank}}", S_HUMAN,
    ...
    MON("N{captain}", S_HUMAN,
        ...
        M2_COLLECT,
        M3_INFRAVISIBLE, CLR_ORANGE | HI_ULINE),
    /* Keep these separate - some of the mkroom code assumes that all the
       soldiers are contiguous. */
    MON("N{watchman}", S_HUMAN,
        ...
        M2_COLLECT,
        M3_INFRAVISIBLE, CLR_CYAN),
    MON("N{N{captain},A{N{watch}}}", S_HUMAN,
    ...
    MON("N{Wizard of Yendor}", S_HUMAN,
 ...
 * (major) demons
 */
    MON("N{N{demon},A{N{water}}}", S_DEMON,
    ...
    MON("N{N{devil},A{horned}}", S_DEMON,
...
#undef SEDUCTION_ATTACKS
    ...
    MON("N{N{devil},A{barbed}}", S_DEMON,
    ...
    MON("N{N{devil},A{N{bone}}}", S_DEMON,
    ...
    /* Named demon lords & princes plus Arch-Devils. (their order matters; see
       minion.c) */
    MON("P{Juiblex}", S_DEMON,
        ...
        CLR_BRIGHT_GREEN | HI_ULINE),
    MON("P{Yeenoghu}", S_DEMON,
 ...
 */
    ...
    MON("N{N{tail},A{N{N{worm},A{long}}}}", S_WORM_TAIL,
        LVL(0, 0, 0, 0, 0), (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, 0, 0, 0), 0, 0, 0L, M2_NOPOLY, 0, CLR_BROWN),

    /* Note: Worm tail must be between the normal monsters and the special
       quest & pseudo-character ones because an optimization in the random
       monster selection code assumes everything beyond here has the G_NOGEN
       and M2_NOPOLY attributes. */

/*
 * character classes
 */
    MON("N{archeologist}", S_HUMAN,
 ...
 */
    ...
    MON("N{Master of Thieves}", S_HUMAN,
        LVL(20, 12, 0, 30, -20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
    ...
    MON("N{Norn}", S_HUMAN,
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_FEMALE | M2_COLLECT
        | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, HI_QUEST),
    MON("P{Neferet the Green}", S_HUMAN,
 ...
 * quest nemeses
 */
    MON("N{Minion of Huhetotl}", S_DEMON,
    ...
    MON("N{Chromatic Dragon}", S_DRAGON,
    ...
    MON("N{Master Assassin}", S_HUMAN,
        ...
        M2_COLLECT | M2_MAGIC,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE, HI_QUEST),
    /* A renegade daimyo who led a 13 year civil war against the shogun of his
       time. */
    MON("P{Ashikaga Takauji}", S_HUMAN,
